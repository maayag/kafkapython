...
class Producer:
    ...
    def __init__(
        ...
        print("check if create topic is necessary")
        # If the topic does not already exist, try to create it
        if self.topic_name not in Producer.existing_topics:
            print("inside if for create topic")
            self.create_topic()
...
if __name__ == "__main__":
    init = Producer(topic_name="station.arrivals.damen", key_schema= "Any")
    init.create_topic()